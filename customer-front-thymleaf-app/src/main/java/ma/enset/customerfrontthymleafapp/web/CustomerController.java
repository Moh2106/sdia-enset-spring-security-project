...
import ma.enset.customerfrontthymleafapp.model.Product;
...
public class CustomerController {
    ...
    public CustomerController(CustomerRepositories customerRepositories, ClientRegistrationRepository clientRegistrationRepository) {
